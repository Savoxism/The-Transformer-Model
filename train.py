...
def train_model(config):
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        for batch in batch_iterator:
            ...
            # Run the tensors through the transformer encoder and decoder
            ...
            proj_output = model.project(decoder_output) # (batch_size, seq_len, vocab_size_tgt)
            
            label = batch['label'].to(device) # (batch_size, seq_len)
            
            # (batch_size, seq_len, vocab_size_tgt) --> (batch_size * seq_len, vocab_size_tgt)
